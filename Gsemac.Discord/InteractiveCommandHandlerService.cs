...
namespace Gsemac.Discord {
    ...
    public class InteractiveCommandHandlerService :
        ...
        public async Task<IUserMessage> GetNextMessageAsync(ICommandContext context, IInteractiveMessageOptions options = null) {

            InteractiveMessageInfo interactiveMessage = new InteractiveMessageInfo(context, options ?? InteractiveMessageOptions.Default);
        ...
        private sealed class InteractiveMessageInfo :
            ...
            public IInteractiveMessageOptions Options { get; set; }
            public ManualResetEvent ResetEvent { get; set; } = new ManualResetEvent(false);
            public bool Cancelled { get; set; } = false;

            public InteractiveMessageInfo(ICommandContext context, IInteractiveMessageOptions options) {
